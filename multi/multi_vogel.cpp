...
int main(int argc,char *argv[])
{
    ...
    mnetwork.Connect(exc,exc,1.0,1.0,false,0.02);
    mnetwork.Connect(exc,inh,1.0,1.0,false,0.02);
    mnetwork.Connect(inh,exc,10.0,1.0,false,0.02);
    mnetwork.Connect(inh,inh,10.0,1.0,false,0.02);
